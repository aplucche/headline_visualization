...
class Dropdown extends React.Component {
  render() {
    return (<select className='dropdown' onChange={this.props.handleDropdownChange}>
        <option value="http://rss.nytimes.com/services/xml/rss/nyt/HomePage.xml">New York Times Homepage</option>
        <option value="http://www.wsj.com/xml/rss/3_7014.xml">WSJ Business News</option>
        <option value="http://feeds.washingtonpost.com/rss/national">Washington Post National</option>
        <option value="http://www.buzzfeed.com/index.xml">Buzz Feed Homepage</option>
        ...
        <option value="http://feeds.theguardian.com/theguardian/uk/rss">The Guardian - UK</option>
      </select>);
  }
}
